...
// virtual:/_102022_/l2/crm/clientOnboarding
...
var ClientOnboarding = class ClientOnboarding2 extends CollabPageElement {
  initPage() {
  ...
  render() {
    ...
    return Z`
      <div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="mb-6">
          ${step === 1 ? Z`<p class="text-gray-700">Bem-vindo! Por favor, informe seus dados pessoais para iniciar o cadastro.</p>` : ""}
          ${step === 2 ? Z`<p class="text-gray-700">Informe seu endereço para contato.</p>` : ""}
          ${step === 3 ? Z`<p class="text-gray-700">Configure suas preferências de comunicação.</p>` : ""}
          ${step === 4 ? Z`<p class="text-gray-700">Revise suas informações antes de finalizar.</p>` : ""}
          ${step === 5 ? Z`<p class="text-green-700 font-semibold">Cadastro concluído com sucesso! Obrigado por se registrar.</p>` : ""}
        </div>
...
ClientOnboarding = __decorate4([
  e2("crm--client-onboarding-102022")
], ClientOnboarding);
...
// virtual:/_102022_crm/clientOnboarding
...
var ClientOnboarding3 = class ClientOnboarding4 extends CollabPageElement {
  initPage() {
    setState("ui.mdm.pageTitle.title", `Onboarding de Clientes`);
    initState("clientOnboarding.step", 1);
  }
