...
// virtual:/_102022_/l2/generalutilities/tipCalculator
...
var TipCalculatorPage = class TipCalculatorPage2 extends CollabPageElement {
  constructor() {
    super();
  }
  initPage() {
    setState("ui.mdm.pageTitle.title", `Calculadora de Gorjeta`);
    initState2("ui.mdm.tipCalculator", {
      billAmount: 0,
      selectedTip: 15,
      customTip: null,
      people: 1,
  ...
  parseNumber(value) {
    ...
    const n4 = parseFloat(cleaned);
    return isNaN(n4) ? 0 : n4;
  }
  onBillInput(e5) {
    const v3 = this.parseNumber(e5.target.value || "0");
    setState("ui.mdm.tipCalculator.billAmount", v3);
    this.requestUpdate();
  }
  onSelectTip(percent) {
  ...
  onCustomTipInput(e5) {
    const v3 = this.parseNumber(e5.target.value || "0");
    setState("ui.mdm.tipCalculator.customTip", v3);
    setState("ui.mdm.tipCalculator.selectedTip", 0);
    this.requestUpdate();
  }
  onPeopleInput(e5) {
    let v3 = parseInt(e5.target.value, 10);
    if (isNaN(v3) || v3 < 1)
      v3 = 1;
    setState("ui.mdm.tipCalculator.people", v3);
    this.requestUpdate();
  }
  onRoundingChange(e5) {
    setState("ui.mdm.tipCalculator.rounding", e5.target.value);
    this.requestUpdate();
  }
  compute() {
    const s4 = getState("ui.mdm.tipCalculator") || {};
    const billAmount = Number(s4.billAmount) || 0;
    const tipPercent = s4.customTip && Number(s4.customTip) > 0 ? Number(s4.customTip) : Number(s4.selectedTip) || 0;
    const people = Math.max(1, Number(s4.people) || 1);
    const rounding = s4.rounding || "none";
...
TipCalculatorPage = __decorate4([
  e2("generalutilities--tip-calculator-102022")
], TipCalculatorPage);
...
// virtual:/_102022_generalutilities/tipCalculator
...
var TipCalculatorPage3 = class TipCalculatorPage4 extends CollabPageElement {
  constructor() {
    super();
  }
  initPage() {
...
TipCalculatorPage3 = __decorate6([
  e2("generalutilities--tip-calculator-102022")
], TipCalculatorPage3);
/**
 * @license
